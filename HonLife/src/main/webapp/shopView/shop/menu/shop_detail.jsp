...
<!-- rocket js -->
	...
	<jsp:include page="../../includer/d_header.jsp"></jsp:include>
</head>
                            ...
                            <div class="ps-product__info">
                                ...
                                <div class="ps-product__meta">
                                    ...
                                    <div class="ps-product__rating">
                                        ...
                                        </select><span>(1 리뷰)</span>
                                    </div>
                                </div>
                                <h4 class="ps-product__price">${product.productPrice } 원</h4>
                                ...
                                <div class="ps-product__specification"><a class="report" href="#">Report Abuse</a>
                                 ...
                                 <%--    <c:choose>
                                    <a href="#">
                                    <c:when test="${product.productType == '1'}">과자/빵</c:when>
                                    <c:when test="${product.productType == '2'}">건강식품</c:when>
                                    <c:when test="${product.productType == '3'}">생수/음료</c:when>
                                    <c:when test="${product.productType == '4'}">유제품</c:when>
                                    <c:when test="${product.productType == '5'}">라면/통조림</c:when>
                                    <c:when test="${product.productType == '6'}">반찬/조미료</c:when></a>,
                                    <a href="#"><c:when test="${product.productDetailtype == '1'}">과자</c:when></a>
                                    </c:choose> --%>
                                    </p>
