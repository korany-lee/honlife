		...
		카테고리: 
			...
			<div class="filter-options-container">
				<ul class="filter-options list-style-none">
						<li class="cat-item cat-item-41"><a href="">의류</a>
				</li>
						<li class="cat-item cat-item-42"><a href="">거실</a>
				</li>
						<li class="cat-item cat-item-43"><a href="">침실</a>
				</li>
